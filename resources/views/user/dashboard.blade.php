            ...
            <div id="sidebar" class="dashboard-sidebar-desktop-wrapper">
                <ul class="dashboard-sidebar-options flex flex-col text-secondaryText">
                    ...
                    <li class="u-sidebar-value" data-page="savedAdverts" onclick="loadPage('savedAdverts')">
                        ...
                        <i class="fa-solid fa-arrow-right-long dark:text-white"></i>
                        <x-text tag="label" class="dashboard-sidebar-title" color="black" darkColor="gray-100">Saved
                            adverts</x-text><br>
                    ...
                    <li class="u-sidebar-value rounded-b-md hover:rounded-b-md border-none" data-page="accountSecurity"
                        onclick="loadPage('accountSecurity')">
            ...
            <div class="u-dashboard-content-wrapper">
                ...
                <div id="dashboard" class="ud-page-wrapper">
                    <div class="ud-dashboard-page bg-white dark:bg-gray-800 p-6 rounded shadow">
                        <x-text tag="h2" size="2xl" weight="bold" color="customBlue" darkColor="gray-100"
                            class="text-[40px] font-mainText">
                    ...
                    <div class="ud-dashboard-page bg-white dark:bg-gray-800 p-6 rounded shadow">
                        ...
                        <div class="flex gap-10 text-[#252a34] mb-4">
                            <x-text tag="p" size="base" weight="normal" color="gray-700" darkColor="gray-300"
                                class="mt-4">
                                We are the fastest growing largest digital automotive marketplace in SriLanka.
                            </x-text>
                        </div>
                        <x-primary-button onclick="loadPage('personalDetails')">
                ...
                <div id="accountSecurity" class="ud-page-wrapper hidden">
                    ...
                    <div class="ud-security-page bg-red-200 dark:bg-gray-800 p-6 rounded shadow">
                        <div class="ud-dlt-acc">
                            <x-text tag="h2" size="2xl" weight="bold" color="[#A82E23]" darkColor="gray-100"
                                class="text-[50px] mb-5">
                                Delete account
                            </x-text>
